...
# ---------------------------------------------------------
# BARRA LATERAL: FILTROS MULTISELECT, ADMIN USUARIOS/PERMISOS Y CERRAR SESIÓN
# ---------------------------------------------------------
    ...
    with st.sidebar.expander("👤 Gestión de Usuarios y Permisos (Admin)"):
        ...
        if st.button("Guardar / Autorizar Usuario"):
            if new_u and new_e and new_p:
                ...
                st.success(f"Usuario `{new_u}` actualizado / autorizado.")
            else:
        ...
        st.dataframe(df_users[['usuario', 'email', 'perm_pestañas']], use_container_width=True)
...
# ---------------------------------------------------------
# MÉTRICAS Y GRÁFICOS RESTAURADOS
# ---------------------------------------------------------
...
# ---------------------------------------------------------
# PESTAÑAS PRINCIPALES DINÁMICAS POR PERMISO
# ---------------------------------------------------------
dict_pestanias = {
    "Tablero": "📊 Tablero",
